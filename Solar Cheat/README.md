# Solar
Solar is a neural network aim assist that uses real-time object detection accelerated with CUDA on Nvidia GPUs.

## About

Solar can be modified to work with a variety of FPS games; however, it is currently configured for Fortnite. Besides being general purpose, the main advantage of using Lunar is that it does meddle with the memory of other processes.

The basis of Solar's player detection is the [YOLOv5](https://github.com/ultralytics/yolov5) architecture written in PyTorch.
...
```           
python Solar.py setup
```
To collect image data for annotating and training:
```           
python Solar.py collect_data
```
...
## License
This project is distributed under [GNU General Public License v3.0](https://github.com/zeyad-mansour/Solar/blob/main/LICENSE) license.
